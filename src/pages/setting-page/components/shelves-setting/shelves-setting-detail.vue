<!--
* @description  参数1
* @fileName  shelves-setting-detail
* @author wjp
* @date 2024-03-12 22:30:28
!-->
<template>
  <div id="shelves-setting-detail" class="shelves-setting-detail">
    <el-drawer
      :title="$t('message.myAccount.shelfDetail')"
    ...
    >
      <el-descriptions class="margin-top" :column="2" border>
        ...
        <el-descriptions-item
          ...
          >{{ form.short_code }}</el-descriptions-item
        >
